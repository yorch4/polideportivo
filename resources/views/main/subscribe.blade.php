        ...
        <div class="col-md-8">
            ...
            <section>
                <ol>
                    ...
                    <li>Descuentos en la inscripción en actividades mensuales.</li>
                    <li>40% dto. si te inscribes en más de una actividad.</li>
                    <li>Más de 60 % dto. en Tarifa Plana.</li>
                    <li>Casi un 40 % dto. en Piscinas.</li>
                    <li>45 % dto. en Senderismos por la Subbética.</li>
                    <li> 40 % dto. en Senderismos fuera de la Subbética.</li>
                    <li>Los abonados infantiles tienen descuentos en cursos.</li>
                    <li>Sólo los abonados pueden adquirir bonos de alquiler de instalaciones de 5 alquileres al precio de 4.</li>
                </ol>
            </section>
        </div>
        <div class="col-md-2"></div>
